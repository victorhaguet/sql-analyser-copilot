...
def build_display_context(response_data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        **build_empty_result_state(),
        ...
        "agent_iterations": response_data.get("agent_iterations", 0),
        "max_agent_iterations": response_data.get("max_agent_iterations"),
        "probe_count": response_data.get("probe_count", 0),
        "max_probes": response_data.get("max_probes"),
        "clarification_rounds": response_data.get("clarification_rounds", 0),
        "max_clarifications": response_data.get("max_clarifications"),
        "clarification_answers": response_data.get("clarification_answers") or [],
        "agent_rationale": response_data.get("agent_rationale"),
        "agent_error": response_data.get("agent_error"),
        "agent_tool_log": response_data.get("agent_tool_log") or [],
